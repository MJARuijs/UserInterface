...
class TexturedBackground(private val textureMap: TextureMap, private var backgroundColor: Color? = null, private var overlayColor: Color? = null, cornerRadius: Float = 0.0f, outline: Float = 0.0f, outlineColor: Color = Color()) : Background(cornerRadius, outline, outlineColor) {
