...
enum class UIColor(val color: Color) {
    ...
    YELLOW_BRIGHT(1.0f, 0.0f, 1.0f, 1.0f),
    YELLOW_LIGHT(0.75f, 0.0f, 0.75f, 1.0f),
    YELLOW(0.5f, 0.0f, 0.5f, 1.0f),
    YELLOW_DARK(0.25f, 0.0f, 0.25f, 1.0f),

    CYAN_BRIGHT(1.0f, 1.0f, 0.0f, 1.0f),
    CYAN_LIGHT(CYAN_BRIGHT.rgb() * 0.75f, 1.0f),
    CYAN(0.5f, 0.5f, 0.0f, 1.0f),
    CYAN_DARK(0.25f, 0.25f, 0.0f, 1.0f),
